...
*/
define("CouchDBStore",["Store","StateMachine","Tools","Promise"],function(a,d,h,c){function e(){var f=null,b={},g=new c,a={getView:function(){b.query=b.query||{};b.query.update_seq=true;f.request("CouchDB",{method:"GET",path:"/"+b.database+"/_design/"+b.design+"/"+b.view,query:b.query},function(a){var c=JSON.parse(a);if(c.rows)this.reset(c.rows),g.resolve(this),typeof c.total_rows=="undefined"&&this.setReducedViewInfo(true),e.event("subscribeToViewChanges",c.update_seq);else throw Error("CouchDBStore ["+
b.database+", "+b.design+", "+b.view+"].sync() failed: "+a);},this)},getDocument:function(){f.request("CouchDB",{method:"GET",path:"/"+b.database+"/"+b.document,query:b.query},function(b){var a=JSON.parse(b);a._id?(this.reset(a),g.resolve(this),e.event("subscribeToDocumentChanges")):g.reject(b)},this)},getBulkDocuments:function(){var a={path:"/"+b.database+"/_all_docs",query:b.query},c;b.keys instanceof Array?(a.method="POST",a.data=JSON.stringify({keys:b.keys}),a.headers={"Content-Type":"application/json"},
c=a.data):(a.method="GET",c=JSON.stringify(b.query));b.query.include_docs=true;b.query.update_seq=true;f.request("CouchDB",a,function(a){var i=JSON.parse(a);if(i.rows)this.reset(i.rows),g.resolve(this),e.event("subscribeToBulkChanges",i.update_seq);else throw Error('CouchDBStore.sync("'+b.database+'", '+c+") failed: "+a);},this)},createDocument:function(a){f.request("CouchDB",{method:"PUT",path:"/"+b.database+"/"+b.document,headers:{"Content-Type":"application/json"},data:this.toJSON()},function(b){b=
JSON.parse(b);b.ok?(a.resolve(b),e.event("subscribeToDocumentChanges")):a.reject(b)})},subscribeToViewChanges:function(a){h.mixin({feed:"continuous",heartbeat:2E4,since:a},b.query);this.stopListening=f.listen("CouchDB",{path:"/"+b.database+"/_changes",query:b.query},function(a){if(a=="\n")return false;var a=JSON.parse(a),g;g=b.reducedView?"updateReduced":a.deleted?"delete":a.changes[0].rev.search("1-")==0?"add":"change";e.event(g,a.id)},this)},subscribeToDocumentChanges:function(){this.stopListening=
f.listen("CouchDB",{path:"/"+b.database+"/_changes",query:{feed:"continuous",heartbeat:2E4}},function(a){if(a=="\n")return false;a=JSON.parse(a);a.id==b.document&&a.changes.pop().rev!=this.get("_rev")&&(a.deleted?e.event("deleteDoc"):e.event("updateDoc"))},this)},subscribeToBulkChanges:function(a){h.mixin({feed:"continuous",heartbeat:2E4,since:a,include_docs:true},b.query);this.stopListening=f.listen("CouchDB",{path:"/"+b.database+"/_changes",query:b.query},function(b){if(b=="\n")return false;var b=
JSON.parse(b),a;a=b.changes[0].rev.search("1-")==0?"bulkAdd":b.deleted?"delete":"bulkChange";e.event(a,b.id,b.doc)},this)},updateDocInStore:function(a){f.request("CouchDB",{method:"GET",path:"/"+b.database+"/_design/"+b.design+"/"+b.view,query:b.query},function(b){b=JSON.parse(b);b.rows.length==this.getNbItems()?b.rows.some(function(b,g){b.id==a&&this.set(g,b)},this):this.actions.evenDocsInStore.call(this,b.rows,a)},this)},evenDocsInStore:function(b,a){var g=this.getNbItems();b.length<g?this.loop(function(b,
g){b.id==a&&this.del(g)},this):b.length>g&&b.some(function(b,g){if(b.id==a)return this.alter("splice",g,0,b)},this)},addBulkDocInStore:function(a){if(b.query.startkey||b.query.endkey)b.query.include_docs=true,b.query.update_seq=true,f.request("CouchDB",{method:"GET",path:"/"+b.database+"/_all_docs",query:b.query},function(b){JSON.parse(b).rows.forEach(function(b,g){b.id==a&&this.alter("splice",g,0,b.doc)},this)},this);else return false},updateBulkDocInStore:function(b,a){this.loop(function(g,c){g.id==
b&&this.set(c,a)},this)},removeDocInStore:function(b){this.loop(function(a,g){a.id==b&&this.del(g)},this)},addDocInStore:function(a){f.request("CouchDB",{method:"GET",path:"/"+b.database+"/_design/"+b.design+"/"+b.view,query:b.query},function(b){JSON.parse(b).rows.some(function(b,g){b.id==a&&this.alter("splice",g,0,b)},this)},this)},updateReduced:function(){f.request("CouchDB",{method:"GET",path:"/"+b.database+"/_design/"+b.design+"/"+b.view,query:b.query},function(b){this.set(0,JSON.parse(b).rows[0])},
this)},updateDoc:function(){f.request("CouchDB",{method:"GET",path:"/"+b.database+"/"+b.document},function(b){this.reset(JSON.parse(b))},this)},deleteDoc:function(){this.reset({})},updateDatabase:function(a){f.request("CouchDB",{method:"PUT",path:"/"+b.database+"/"+b.document,headers:{"Content-Type":"application/json"},data:this.toJSON()},function(b){b=JSON.parse(b);b.ok?(this.set("_rev",b.rev),a.resolve(b)):a.reject(b)},this)},updateDatabaseWithBulkDoc:function(a){var g=[];this.loop(function(b){g.push(b.doc)});
f.request("CouchDB",{method:"POST",path:"/"+b.database+"/_bulk_docs",headers:{"Content-Type":"application/json"},data:JSON.stringify({docs:g})},function(b){a.resolve(JSON.parse(b))})},removeFromDatabase:function(){f.request("CouchDB",{method:"DELETE",path:"/"+b.database+"/"+b.document,query:{rev:this.get("_rev")}})},unsync:function(){this.stopListening();delete this.stopListening}},e=new d("Unsynched",{Unsynched:[["getView",a.getView,this,"Synched"],["getDocument",a.getDocument,this,"Synched"],["getBulkDocuments",
a.getBulkDocuments,this,"Synched"]],Synched:[["updateDatabase",a.createDocument,this],["subscribeToViewChanges",a.subscribeToViewChanges,this,"Listening"],["subscribeToDocumentChanges",a.subscribeToDocumentChanges,this,"Listening"],["subscribeToBulkChanges",a.subscribeToBulkChanges,this,"Listening"],["unsync",function(){},"Unsynched"]],Listening:[["change",a.updateDocInStore,this],["bulkAdd",a.addBulkDocInStore,this],["bulkChange",a.updateBulkDocInStore,this],["delete",a.removeDocInStore,this],["add",
a.addDocInStore,this],["updateReduced",a.updateReduced,this],["updateDoc",a.updateDoc,this],["deleteDoc",a.deleteDoc,this],["updateDatabase",a.updateDatabase,this],["updateDatabaseWithBulkDoc",a.updateDatabaseWithBulkDoc,this],["removeFromDatabase",a.removeFromDatabase,this],["unsync",a.unsync,this,"Unsynched"]]});this.sync=function(b,a,d,f){g=new c;if(typeof b=="string"&&typeof a=="string"&&typeof d=="string")return this.setSyncInfo(b,a,d,f),e.event("getView"),g;else if(typeof b=="string"&&typeof a==
"string"&&typeof d!="string")return this.setSyncInfo(b,a,d),e.event("getDocument"),g;else if(typeof b=="string"&&a instanceof Object)return this.setSyncInfo(b,a),e.event("getBulkDocuments"),g;return false};this.setSyncInfo=function(a,g,c,d){this.clearSyncInfo();if(typeof a=="string"&&typeof g=="string"&&typeof c=="string")return b.database=a,b.design=g,b.view=c,b.query=d,true;else if(typeof a=="string"&&typeof g=="string"&&typeof c!="string")return b.database=a,b.document=g,b.query=c,true;else if(typeof a==
...
define("Promise",["Observable","StateMachine"],function(a,d){return function(){var h,c,e=new d("Unresolved",{Unresolved:[["resolve",function(b){h=b;f.notify("success",b)},"Resolved"],["reject",function(b){c=b;f.notify("fail",b)},"Rejected"],["addSuccess",function(b,a){f.watch("success",b,a)}],["addFail",function(b,a){f.watch("fail",b,a)}]],Resolved:[["addSuccess",function(b,a){b.call(a,h)}]],Rejected:[["addFail",function(a,g){a.call(g,c)}]]}),f=new a;this.resolve=function(a){return e.event("resolve",
a)};this.reject=function(a){return e.event("reject",a)};this.then=function(a,g,c,d){a instanceof Function&&(g instanceof Function?e.event("addSuccess",a):e.event("addSuccess",a,g));g instanceof Function&&e.event("addFail",g,c);c instanceof Function&&e.event("addFail",c,d);return this};this.getObservable=function(){return f};this.getStateMachine=function(){return e}}});
...
define("Transport",["Store"],function(){return function(a){var d=null;this.setReqHandlers=function(a){return a instanceof Object?(d=a,true):false};this.getReqHandlers=function(){return d};this.request=function(a,c,e,f){return d.has(a)&&typeof c!="undefined"?(d.get(a)(c,function(){e&&e.apply(f,arguments)}),true):false};this.listen=function(a,c,e,f){if(d.has(a)&&typeof c!="undefined"&&typeof e=="function"){var b=function(){e.apply(f,arguments)},g;g=d.get(a)(c,b,b);return function(){g.func.call(g.scope)}}else return false};
